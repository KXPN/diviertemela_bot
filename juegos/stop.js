...
function enviarInstrucciones(t, evento) {
        const mensajeLineas = [
                ...
                'una hoja, y algunas cateogrías podrían ser:',
                '»- Animal',
                '»- Comida',
                '»- Famoso',
                '»- Lugar',
                ...
                '»- Prefiero que me',
                '»',
                '»2. Escoges una letra (aquí es cuando entro yo) y con ella →',
                'debes iniciar todas las respuestas',
                '»',
                '»3. El primer jugador en haber llenado todas las categorías →',
                'dice STOP y los demás deben dejar de escribir. Luego lee →',
                'cada categoría y cada jugador, incluyéndolo, lee lo que →',
                'escribió en ella. Los puntajes se suelen manejar así:',
                '»- 200 puntos para una sola persona si llenó correctamente la →',
                'categoría que nadie más llenó',
                '»- 100 puntos para todas las personas que hayan llenado →',
                'correctamente la categoría, con una respuesta única (que →',
                'nadie más escribió)',
